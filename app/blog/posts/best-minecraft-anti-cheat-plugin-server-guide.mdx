...
**Packet-based systems** like Karhu Anti-Cheat and Redux AntiCheat intercept player data at the network level, before it even hits the [Spigot](https://mcserverjars.com/spigot) API or Bukkit events. This method catches cheats closer to the source and has a lighter touch on your server's TPS and main thread performance.
...
Open-source options like Grim Anti-Cheat give you transparency and are developed by the community, but you'll need more technical know-how to set them up and fix problems. Make sure you're running optimized server software like [Paper](https://mcserverjars.com/paper) to get the most out of any anti-cheat solution.
