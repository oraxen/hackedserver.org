...
export default function FullscreenButton({ onClick }: FullscreenButtonProps) {
  return (
    ...
    >
      ...
      {/* Subtle glow */}
      <span className="absolute inset-0 rounded-lg bg-gradient-to-t from-cyan-400/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
    </button>
  );
}
